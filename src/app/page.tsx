  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans select-none pb-24">
      ...
      <main className="w-full flex-1 px-4 sm:px-8 py-5 max-w-7xl mx-auto space-y-6">
              ...
              <div className="lg:col-span-2 bg-white rounded-3xl p-5 border border-slate-200/80 shadow-xs space-y-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400">点击商家/对方名字可快捷筛选其全部流水</p>
                  </div>
                  <button 
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            <button 
                              ...
                              className="text-sm font-semibold text-slate-800 hover:text-blue-600 hover:underline text-left"
                              title="点击筛选该收款方/付款方"
                            >
                              {tx.title}
                            </button>
        ...
        {/* 3. 流水明细 Tab（包含收款方/付款方快速下拉筛选与点击下钻） */}
        {activeTab === "records" && (
          <div className="w-full bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs space-y-5">
            ...
            <div className="flex flex-col gap-3.5 border-b border-slate-100 pb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h2 className="text-base font-bold text-slate-800 flex items-center gap-1.5">
                      ...
                      {!selectedCategoryDetail && !selectedCounterparty && <span>全量财务流水</span>}
                    </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                ...
                <div className="sm:col-span-1">
                  <select
                    ...
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium text-slate-800 focus:outline-none focus:border-blue-500 transition-colors"
                  >
              ...
              <div className="flex items-center gap-1.5 overflow-x-auto pb-1 text-xs">
                <span className="text-slate-400 text-[11px] whitespace-nowrap">高频交易方:</span>
